...
- [Live scan results table](assets/sports-middling-live-results-table-wide.png)
- [Payoff lab](assets/sports-middling-payoff-lab-wide.png)
- [Model notes](assets/sports-middling-model-notes-wide.png)
